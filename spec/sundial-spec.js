...
describe("difference", function() {
	...
	it("should return difference in degrees when the hour is 2 and the minutes are 45", function() {
		var degrees = sundial.difference(2, 45);
		expect(degrees).toBe(172.5);
	})
})
